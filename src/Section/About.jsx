    ...
    <section className="sm:px-6 px-5 my-20" id="about">
      ...
      <div className="grid xl:grid-cols-4 xl:gird-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="col-span-2 xl:col-span-1">
          <div className="w-full h-full bg-zinc-900 border-zinc-800 rounded-lg flex flex-col">
            <img
              ...
              alt="Noel Eruotor"
              className="w-full border rounded-xl border-gray-700 h-fit object-cover transform hover:scale-105 transition-transform duration-500"
            />
          </div>
        </div>
