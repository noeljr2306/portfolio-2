...
const About = () => {
  ...
  return (
    <section className="sm:px-6 px-5 my-20" id="about">
      <GlitchText as="h1" text="About Me" className="heading" />
              ...
              <div className="flex mt-5 gap-3 flex-wrap">
                <div className="flex gap-1 border border-zinc-800 bg-zinc-800 p-2 rounded-lg transform hover:scale-105 transition-transform duration-200 min-w-0">
                  ...
                  <GlitchText
                    as="p"
                    text="Nigeria"
                    className="green-text-gradient truncate"
                  />
                </div>
                <div className="flex gap-1 border p-2 rounded-lg border-zinc-800 bg-zinc-800 transform hover:scale-105 transition-transform duration-200 min-w-0">
                  ...
                  <GlitchText
                    as="p"
                    text="English"
                    className="orange-text-gradient truncate"
                  />
                </div>
                <div className="flex gap-1 border p-2 rounded-lg border-zinc-800 bg-zinc-800 transform hover:scale-105 transition-transform duration-200 min-w-0">
                  ...
                  <GlitchText
                    ...
                    className="blue-text-gradient truncate"
                  />
                </div>
                <div className="flex gap-1 border p-2 rounded-lg border-zinc-800 bg-zinc-800 transform hover:scale-105 transition-transform duration-200 min-w-0">
                  <FaEthereum className="mt-1 text-purple-400" />
                  <GlitchText
                    as="p"
                    text="Web3 Developer"
                    className="violet-gradient truncate"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="grid-container relative overflow-hidden">
            <div className="relative z-10">
              <GlitchText
                ...
                className="grid-headtext flex items-center gap-2"
              />
